...
### Sprint 14 Network Adapter Plan
TCP/UDP network listeners are tracked as a dedicated Sprint 14 scope. See:

- `docs/sprints/sprint-14-network-log-adapters.md`
- `docs/tasks/TASKS-SPRINT-14-NETWORK-LOG-ADAPTERS.md`
