...
### Sprint 18 Network Adapter Plan
TCP/UDP network listeners are tracked as a dedicated Sprint 18 scope. See:

- `docs/sprints/sprint-18-network-log-adapters.md`
- `docs/tasks/TASKS-SPRINT-18-NETWORK-LOG-ADAPTERS.md`
