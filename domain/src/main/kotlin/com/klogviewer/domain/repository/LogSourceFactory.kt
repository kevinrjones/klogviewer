...
interface LogSourceFactory {
    ...
    fun createS3Source(config: S3Config, parser: LogParser? = null): LogSource
    fun createS3DirectorySource(config: S3Config, remoteFileSystem: RemoteFileSystem): LogSource
