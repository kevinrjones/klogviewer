# Sprint 15: Network Log Adapters
...
### 2.2. Compatibility Targets (Sprint 15)
...
- **Compatibility Profiles**: Add parser/codec profiles so major logging ecosystems can emit directly to Sprint 15 listeners.
