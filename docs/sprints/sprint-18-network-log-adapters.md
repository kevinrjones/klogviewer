# Sprint 18: Network Log Adapters
...
### 2.2. Compatibility Targets (Sprint 18)
...
- **Compatibility Profiles**: Add parser/codec profiles so major logging ecosystems can emit directly to Sprint 18 listeners.
