# Sprint 17: Network Log Adapters
...
### 2.2. Compatibility Targets (Sprint 17)
...
- **Compatibility Profiles**: Add parser/codec profiles so major logging ecosystems can emit directly to Sprint 17 listeners.
